...
import { Skull, Instagram, Facebook, Twitter, Mail, Phone, MapPin } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="mb-6">
              Where darkness meets sophistication. Premium accessories for those who embrace the shadows.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span>Dark Tower, Shadow Avenue<br />Nocturnal City, NC 13666</span>
              </li>
          ...
          {/* Newsletter */}
          <div>
            <h3 className="text-white gothic-text text-lg mb-6">Opening Hours</h3>
            <ul className="space-y-3">
            ...
            <p className="mt-6 text-sm">
              The darkness awaits. Visit our physical location for a full immersion.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0">
              <a href="#" className="text-gray-400 hover:text-white transition-colors mx-3 text-sm">
                Privacy Policy
              </a>
              <a href="#" className="text-gray-400 hover:text-white transition-colors mx-3 text-sm">
                Terms of Service
